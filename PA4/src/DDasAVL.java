public class DDasAVL<K extends Comparable<? super K>, D> implements DD<K,D>{
	...
	public DDasAVL(){root = null;} //Constructor
	...
	public int height(){return height(root);}// Not relevant to DD's -- used for comparing performance with AVL trees
	...
	private int height(AVLtree<K,D> t){ return ( t == null)? -1 : t.height;}
